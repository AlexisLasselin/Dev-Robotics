# Part 1:
#  Objective: What would your total score be if everything goes exactly according to your strategy guide (your puzzle input)?
...
# Part 2:
# Same as part 1, but now the X Y & Z symbolize what action to take, not what shape to play
...
print(print(sum([points_per_round2(round_string) for round_string in rounds])))